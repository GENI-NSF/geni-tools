...
As of gcf 2.8, the GCF AM provides the ability allocate resources
...
slice, project, authority) to some limit.

Any AM that is built as a delegate on the GCF AM framework will inherit this
capability transparently.

One feature that remains to be implementated and standardized is the
