...
== Known Issues and Limitations ==
 ...
 - If your circuit goes across ProtoGENI Utah (nickname `pg-utah`)
 (including `pg-utah`, `ig-utah` and `utah-ddc`), then you will need
 to explicitly set the MTU on your link in order to exchange TCP
 traffic. Otherwise, while `ping` will work, most other traffic will
 not pass. 
  - Workaround: After reserving your circuit, log in to your nodes and
  change the MTU to 1497.
